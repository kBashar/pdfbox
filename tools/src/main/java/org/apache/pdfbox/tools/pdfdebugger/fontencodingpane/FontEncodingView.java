...
class FontEncodingView
{
    ...
    FontEncodingView(Object[][] tableData, String encodingName, String fontName,
                     int totalGlyph)
    {
        createView(getHeaderPanel(encodingName, fontName, totalGlyph), getTable(tableData));
    }
    ...
    private JTable getTable(Object[][] tableData)
    {
        JTable table = new JTable(tableData, new String[] {"Code", "Glyph Name"});
    ...
    private JPanel getHeaderPanel(String encodingName, String fontName, int glyphCount)
    {
        ...
        JLabel glyphCountLabel = new JLabel("Total glyph: " + glyphCount);
